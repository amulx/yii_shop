                ...
                <div class="span4 box">
                    <div class="content-wrap">
                        ...
                        <div class="form-group field-admin-adminuser">
                            ...
                            <?php echo $from->field($model,'adminuser')->hiddenInput(); ?>
                        </div>
                        <div class="form-group field-admin-adminpass">
                            <p class="help-block help-block-error"></p>
                            <?php echo $from->field($model,'adminpass')->passwordInput(['class'=>'span12','placeholder'=>'新密码']); ?>
                        </div>
                        <div class="form-group field-admin-adminpass">
                            <p class="help-block help-block-error"></p>
                            <?php echo $from->field($model,'repass')->passwordInput(['class'=>'span12','placeholder'=>'确认密码密码']); ?>
                        </div>                        
