                            ...
                            <div class="container">
                                <?php
                                    ...
                                    $form = ActiveForm::begin([
                                        'fieldConfig'=>[
                                            'template' => '<div class="span12 field-box">{label}{input}</div><p class="help-block help-block-error">{error}</p>'
                                        ],
                                        'options' => [
                                            'class' => 'new_user_form inline_input',
                                        ],
                                    ]);
                                ?>
                                    ...
                                    <div class="form-group field-user-userpass">
                                        <?php echo $form->field($model,'userpass')->textInput(['class'=>'span9']);?>
                                    </div>
                                    ...
                                    <div class="span11 field-box actions">
                                        ...
                                        <span>OR</span>
                                        <?php echo Html::resetButton('取消',['class'=>'reset']);?></div>                                        
                                <?php ActiveForm::end();?>
                            </div>
                        </div>
                        <!-- side right column -->
